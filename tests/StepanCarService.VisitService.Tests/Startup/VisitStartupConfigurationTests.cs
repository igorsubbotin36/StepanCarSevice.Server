...
namespace StepanCarService.VisitService.Tests.Startup;

// Запуск Visit: общие регистрации и отказ стартовать с опасной конфигурацией.
// Контроллеры и сервисы Visit проверяются после завершения разработки сервиса
[Trait(TestCategories.Name, TestCategories.Startup)]
[Collection(TestCollections.Database)]
public class VisitStartupConfigurationTests(VisitServiceFactory factory)
