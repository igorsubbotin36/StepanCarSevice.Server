namespace StepanCarSevice.DetailService.Application.Models.DTO
{
    ...
    public record CarModificationReadDto(int id, string Name, int CarModelId, string? EngineValue, int EngineTypeId, string EngineName, int EnginePower, int WheelDriveTypeId, int TransmissionTypeId);
